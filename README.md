...
Baileys and its maintainers cannot be held liable for misuse of this application, as stated in the [MIT license](https://github.com/LordTech-spare/Baileys/blob/master/LICENSE).
...
```
yarn add @LordTech-spair/baileys
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```
yarn add github:LordTech-spair/Baileys
```

Then import your code using:
``` ts 
import makeWASocket from '@LordTech-spair/baileys'
```
...
``` ts
import makeWASocket, { DisconnectReason } from '@LordTech-spair/baileys'
...
``` ts
import makeWASocket, { BufferJSON, useMultiFileAuthState } from '@LordTech-spair/baileys'
...
``` ts
import makeWASocket, { makeInMemoryStore } from '@LordTech-spair/baileys'
...
``` ts
import { MessageType, MessageOptions, Mimetype } from '@LordTech-spair/baileys'
...
- **MiscGenerationOptions**: some extra info about the message. It can have the following __optional__ values:
    ...
    const info: MessageOptions = {
        ...
        mimetype: Mimetype.pdf, /* (for media messages) specify the type of media (optional for all media types except documents),
                                    import {Mimetype} from '@LordTech-spair/baileys'
                                */
...
import { downloadMediaMessage } from '@LordTech-spair/baileys'
